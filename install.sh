...
curl -s https://raw.githubusercontent.com/GoogleChromeLabs/ps-analysis-tool/4d26f3daeea86db82f1e39692e23d79713627d72/chrome_launcher.sh -o ~/bin/chrome_launcher.sh
