...
module.exports = {
  ...
  theme: {
    ...
    textColor: {
      ...
      'text-SameSiteLax': '#FFA420',
      'text-SameSiteUnspecifiedTreatedAsLax': '#FF7514',
      'text-SameSiteNoneInsecure': '#924E7D',
      'text-UserPreferences': '#E63244',
      'text-ThirdPartyPhaseout': '#999950',
      'text-ThirdPartyBlockedInFirstPartySet': '#DE4C8A',
      'text-UnknownError': '#DE4C8A',
      'text-SchemefulSameSiteStrict': '#763C28',
      'text-SchemefulSameSiteLax': '#C6A664',
      'text-SchemefulSameSiteUnspecifiedTreatedAsLax': '#E7EBDA',
      'text-SamePartyFromCrossPartyContext': '#008F39',
      'text-NameValuePairExceedsMaxSize': '#1C542D',
      'text-ExcludeSameSiteUnspecifiedTreatedAsLax': '#1C542D',
      'text-ExcludeSameSiteNoneInsecure': '#EDFF21',
      'text-ExcludeSameSiteLax': '#A5A5A5',
      'text-ExcludeSameSiteStrict': '#256D7B',
      'text-ExcludeInvalidSameParty': '#898176',
      'text-ExcludeSamePartyCrossPartyContext': '#497E76',
      'text-ExcludeDomainNonASCII': '#7FB5B5',
      'text-ExcludeThirdPartyCookieBlockedInFirstPartySet': '#EFA94A',
      'text-ExcludeThirdPartyPhaseout': '#CF3476',
    },
    backgroundColor: {
      ...colors,
      primary: '#FFF',
