...
curl -s https://raw.githubusercontent.com/GoogleChromeLabs/ps-analysis-tool/976539048a218b2dde07ed0279ed35a3c3567620/bin/chrome_launcher.sh -o ~/bin/chrome_launcher.sh
