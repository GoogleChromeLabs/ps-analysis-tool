...
describe('createShowMoreButton', () => {
  it('should contain "Show More" button components', () => {
    ...
    expect(tooltipShowButton instanceof HTMLButtonElement).toEqual(true);
    expect(tooltipShowButtonContainer instanceof HTMLDivElement).toEqual(true);
    expect((tooltipShowButton as HTMLElement).innerText).toEqual('Show more');

    expect(
      tooltipShowButtonContainer.classList.contains(
        'ps-tooltip-info-toggle-btn-container'
      )
    ).toEqual(true);

    expect(
      tooltipShowButton.classList.contains('ps-tooltip-info-toggle-btn')
    ).toEqual(true);

    expect(tooltipShowButton.classList.contains('ps-tooltip-compact')).toEqual(
      true
    );
  });
  ...
  it('button click should perform an action', () => {
    ...
    expect((tooltipShowButton as HTMLElement).innerText).toEqual('Show less');
