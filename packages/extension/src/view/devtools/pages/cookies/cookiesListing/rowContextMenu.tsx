...
>(function RowContextMenu(
  ...
  const handleAllowListClick = useCallback(
    async (e: React.MouseEvent<HTMLElement>) => {
      ...
      setContextMenuOpen(false);
      reloadCurrentTab(chrome.devtools.inspectedWindow.tabId);
    },
    [
      dotPrefixedDomain,
      domainsInAllowList,
          ...
          <div className="transition duration-100" data-testid="column-menu">
            ...
            >
              <button
                ...
                className="w-full text-small-body rounded px-1 py-[3px] flex items-center hover:bg-blueberry hover:text-white cursor-default"
              >
                <span>
                  {
                    // @ts-ignore
