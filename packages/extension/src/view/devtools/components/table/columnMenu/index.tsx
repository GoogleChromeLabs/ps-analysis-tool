    ...
    <>
      {open &&
        createPortal(
          ...
          >
            <div
              className="absolute z-50 text-raisin-black rounded-md backdrop-blur-2xl w-screen max-w-[13rem] p-1.5 mr-2 divide-y divide-neutral-300 max-h-[80vh] overflow-auto bg-stone-200 shadow-3xl"
              style={{
