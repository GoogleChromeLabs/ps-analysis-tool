...
import screenshot from '../../../../../../../public/images/ad-auction-worklet-breakpoints.png';
        ...
        <ul className="mt-3 list-disc ml-3">
          <li className="mb-2">
            <p>
              ...
              bid for an ad impression, all happening directly on the
              user&apos;s device during a privacy-focused auction process, where
              user data is protected and not shared across websites
            </p>
          </li>
          <li className="mb-2">
            <p>
              <strong>Bidder Reporting Phase Start: </strong>
              refers to the point in an online ad auction where the winning
              bidder is determined and the relevant information about the
              auction results, such as the winning bid and other details, are
              sent back to the participating buyers (bidders) as a report, all
              while maintaining user privacy within the Privacy Sandbox
              framework
            </p>
          </li>
          <li className="mb-2">
