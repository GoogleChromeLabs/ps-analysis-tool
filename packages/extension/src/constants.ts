...
export const DEVTOOLS_TO_CONTENT_SCRIPT_GET_PREBID_DATA =
  'DEVTOOLS:CS:GET_PREBID_DATA';
export const CONTENT_SCRIPT_TO_SCRIPT_GET_PREBID_DATA =
  'CS:SCRIPT:GET_PREBID_DATA';
