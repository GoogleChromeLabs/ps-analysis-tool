...
export const tabCookies: TabCookies = {
  '_gcl_aurtcamp.com/': {
    ...
    networkEvents: {
      requestEvents: [
        {
          type: 'CHROME_WEBREQUEST_ON_BEFORE_SEND_HEADERS' as REQUEST_EVENT.CHROME_WEBREQUEST_ON_BEFORE_SEND_HEADERS,
          requestId: '13079',
          url: 'https://rtcamp.com/wp-content/uploads/sites/2/2020/11/site-logo-black.svg',
          blocked: false,
        ...
        {
          type: 'CDP_REQUEST_WILL_BE_SENT_EXTRA_INFO' as REQUEST_EVENT.CDP_REQUEST_WILL_BE_SENT_EXTRA_INFO,
          requestId: '82785.126',
          url: '',
          blocked: false,
    ...
    frameIdList: [0],
    blockingStatus: {
      inboundBlock: 'NOT_BLOCKED' as BLOCK_STATUS.NOT_BLOCKED,
      outboundBlock: 'NOT_BLOCKED' as BLOCK_STATUS.NOT_BLOCKED,
    },
    isBlocked: false,
    blockedReasons: [],
    warningReasons: [],
  ...
  'FPIDrtcamp.com/': {
    ...
    networkEvents: {
      ...
      responseEvents: [
        {
          type: 'CDP_RESPONSE_RECEIVED_EXTRA_INFO' as RESPONSE_EVENT.CDP_RESPONSE_RECEIVED_EXTRA_INFO,
          requestId: '82785.126',
          url: '',
          blocked: false,
        ...
        {
          type: 'CHROME_WEBREQUEST_ON_RESPONSE_STARTED' as RESPONSE_EVENT.CHROME_WEBREQUEST_ON_RESPONSE_STARTED,
          requestId: '13104',
          url: 'https://ggsutfx.rtcamp.com/g/collect?v=2&tid=G-7HKDVLRRV4&gtm=45je4430v882644066z871645728za200&_p=1712649838568&gcd=13l3l3l3l1&npa=0&dma=0&cid=1593307359.1712122812&ecid=1798602937&ul=en-us&sr=1440x900&_fplc=0&ur=IN-KA&uaa=arm&uab=64&uafvl=Google%2520Chrome%3B123.0.6312.107%7CNot%253AA-Brand%3B8.0.0.0%7CChromium%3B123.0.6312.107&uamb=0&uam=&uap=macOS&uapv=14.3.0&uaw=0&are=1&pae=1&pscdl=noapi&sst.uc=IN&sst.gse=1&sst.etld=google.co.in&sst.gcd=13l3l3l3l1&sst.tft=1712649838568&sst.ude=0&_s=1&sid=1712649839&sct=11&seg=0&dl=https%3A%2F%2Frtcamp.com%2F&dt=Robust%20Enterprise%20WordPress%20Solutions%20%7C%20rtCamp&en=page_view&_ss=1&ep.content_group=Other&tfd=1037&richsstsse',
          blocked: false,
  ...
  'stg_returning_visitorrtcamp.com/': {
    ...
    blockingStatus: {
      inboundBlock: 'NOT_BLOCKED' as BLOCK_STATUS.NOT_BLOCKED,
      outboundBlock:
        'BLOCKED_IN_ALL_EVENTS' as BLOCK_STATUS.BLOCKED_IN_ALL_EVENTS,
    },
    isBlocked: true,
