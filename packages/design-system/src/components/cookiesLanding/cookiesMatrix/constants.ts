...
export const BLOCKED_COOKIE_LEGEND_DATA: LegendData = {
  SecureOnly: {
    description:
      "<p class='font-medium'>This cookie was blocked because it had the 'Secure' attribute and the connection was not secure.</p>",
    countClassName: 'text-secureonly',
  },
  DomainMismatch: {
    description:
      "<p class='font-medium'>This cookie was blocked because the request URL's domain did not exactly match the cookie's domain, nor was the request URL's domain a subdomain of the cookie's Domain attribute value.</p>",
    countClassName: 'text-domainmismatch',
  },
  NotOnPath: {
    description:
      "<p class='font-medium'>This cookie was blocked because its path was not an exact match for, or a superdirectory of, the request URL's path.</p>",
    countClassName: 'text-notonpath',
  },
  SameSiteStrict: {
    description:
      "<p class='font-medium'>This cookie was blocked because it had the <code>SameSite=Strict</code> attribute and the request was made from a different site. This includes top-level navigation requests initiated by other sites.</p>",
    countClassName: 'text-samesitestrict',
  },
  SameSiteLax: {
    description:
      "<p class='font-medium'>This cookie was blocked because it had the <code>SameSite=Lax</code> attribute and the request was made from a different site and was not initiated by a top-level navigation.</p>",
    countClassName: 'text-samesitelax',
  },
  SameSiteUnspecifiedTreatedAsLax: {
    description:
      "<p class='font-medium'>This cookie didn't specify a 'SameSite' attribute when it was stored, was defaulted to <code>SameSite=Lax</code>, and was blocked because the request was made from a different site and was not initiated by a top-level navigation. The cookie had to have been set with <code>SameSite=None</code> to enable cross-site usage.</p>",
    countClassName: 'text-samesiteunspecifiedtreatedaslax',
  },
  SameSiteNoneInsecure: {
    description:
      "<p class='font-medium'>This cookie was blocked because it had the <code>SameSite=None</code> attribute but was not marked 'Secure'. Cookies without SameSite restrictions must be marked 'Secure' and sent over a secure connection.</p>",
    countClassName: 'text-samesitenoneinsecure',
  },
  UserPreferences: {
    description:
      "<p class='font-medium'>This cookie was blocked due to user preferences.</p>",
    countClassName: 'text-userpreferences',
  },
  ThirdPartyPhaseout: {
    description:
      "<p class='font-medium'>Prepare for phasing out third-party cookies</p>",
    countClassName: 'text-thirdpartyphaseout',
  },
  ThirdPartyBlockedInFirstPartySet: {
    description:
      "<p class='font-medium'>The cookie was blocked by third-party cookie blocking between sites in the same First-Party Set.</p>",
    countClassName: 'text-thirdpartyblockedinfirstpartyset',
  },
  UnknownError: {
    description: "<p class='font-medium'>Unknown error</p>",
    countClassName: 'text-unknownerror',
  },
  SchemefulSameSiteStrict: {
    description:
      "<p class='font-medium'>This cookie was blocked because it had the <code>SameSite=Strict</code> attribute but the request was cross-site. This includes top-level navigation requests initiated by other sites. This request is considered cross-site because the URL has a different scheme than the current site.</p>",
    countClassName: 'text-schemefulsamesitestrict',
  },
  SchemefulSameSiteLax: {
    description:
      "<p class='font-medium'>This cookie was blocked because it had the <code>SameSite=Lax</code> attribute but the request was cross-site and was not initiated by a top-level navigation. This request is considered cross-site because the URL has a different scheme than the current site.</p>",
    countClassName: 'text-schemefulsamesitelax',
  },
  SchemefulSameSiteUnspecifiedTreatedAsLax: {
    description:
      "<p class='font-medium'>This cookie didn't specify a 'SameSite' attribute when it was stored, was defaulted to 'SameSite=Lax\"', and was blocked because the request was cross-site and was not initiated by a top-level navigation. This request is considered cross-site because the URL has a different scheme than the current site.</p>",
    countClassName: 'text-schemefulsamesiteunspecifiedtreatedaslax',
  },
  SamePartyFromCrossPartyContext: {
    description:
      "<p class='font-medium'>This cookie was blocked because it had the 'SameParty' attribute but the request was cross-party. The request was considered cross-party because the domain of the resource's URL and the domains of the resource's enclosing frames/documents are neither owners nor members in the same first-party set.</p>",
    countClassName: 'text-samepartyfromcrosspartycontext',
  },
  NameValuePairExceedsMaxSize: {
    description:
      "<p class='font-medium'>This cookie was blocked because it was too large. The combined size of the name and value must be less than or equal to 4,096 characters.</p>",
    countClassName: 'text-namevaluepairexceedsmaxsize',
  },
  ExcludeSameSiteUnspecifiedTreatedAsLax: {
    description:
      "<p class='font-medium'>This <code>Set-Cookie</code> header didn't specify a 'SameSite' attribute and was defaulted to <code>SameSite=Lax,</code> and was blocked because it came from a cross-site response which was not the response to a top-level navigation. The <code>Set-Cookie</code> had to have been set with <code>SameSite=None</code> to enable cross-site usage.</p>",
