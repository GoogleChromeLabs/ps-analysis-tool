...
export const BLOCKED_COOKIE_LEGEND_DATA: LegendData = {
  ...
  SameSiteStrict: {
    description:
      "<p class='font-medium'>This cookie was blocked because it had the 'SameSite=Strict' attribute and the request was made from a different site. This includes top-level navigation requests initiated by other sites.</p>",
    countClassName: 'text-samesitestrict',
  },
  SameSiteLax: {
    description:
      "<p class='font-medium'>This cookie was blocked because it had the 'SameSite=Lax' attribute and the request was made from a different site and was not initiated by a top-level navigation.</p>",
    countClassName: 'text-samesitelax',
  },
  SameSiteUnspecifiedTreatedAsLax: {
    description:
      "<p class='font-medium'>This cookie didn't specify a 'SameSite' attribute when it was stored, was defaulted to 'SameSite=Lax', and was blocked because the request was made from a different site and was not initiated by a top-level navigation. The cookie had to have been set with 'SameSite=None' to enable cross-site usage.</p>",
    countClassName: 'text-samesiteunspecifiedtreatedaslax',
  },
  SameSiteNoneInsecure: {
    description:
      "<p class='font-medium'>This cookie was blocked because it had the 'SameSite=None' attribute but was not marked 'Secure'. Cookies without SameSite restrictions must be marked 'Secure' and sent over a secure connection.</p>",
  ...
  SchemefulSameSiteStrict: {
    description:
      "<p class='font-medium'>This cookie was blocked because it had the 'SameSite=Strict' attribute but the request was cross-site. This includes top-level navigation requests initiated by other sites. This request is considered cross-site because the URL has a different scheme than the current site.</p>",
    countClassName: 'text-schemefulsamesitestrict',
  },
  SchemefulSameSiteLax: {
    description:
      "<p class='font-medium'>This cookie was blocked because it had the 'SameSite=Lax' attribute but the request was cross-site and was not initiated by a top-level navigation. This request is considered cross-site because the URL has a different scheme than the current site.</p>",
