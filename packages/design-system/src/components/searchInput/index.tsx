...
const SearchInput = ({
  ...
  return (
    <div
      ...
      className={`w-3/5 cursor-text bg-white dark:bg-charleston-green text-raisin-black dark:text-bright-gray border rounded flex justify-between items-center gap-1 mx-[3px] my-px px-[3px] pt-0.5 pb-px box-content text-small-body ${
        isFocused
