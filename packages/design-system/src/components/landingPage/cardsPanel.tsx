            ...
            <div className="flex gap-x-5 gap-y-4 flex-wrap mt-2">
              {pinnedItems.map((item) => {
                ...
                return (
                  <div
                    key={item.name}
                    className="w-[366px] border border-gray-300 dark:border-quartz px-3 py-4 flex gap-2 justify-start rounded hover:cursor-pointer hover:bg-light-gray dark:hover:bg-charleston-green hover:shadow hover:scale-[1.03] transition-all duration-150 ease-in-out"
            ...
            <div className="flex gap-5 flex-wrap mt-2">
              {featuredItems.map((item) => {
                ...
                return (
                  <div
                    key={item.name}
                    className="w-[366px] rounded border border-gray-300 dark:border-quartz   px-3 py-4 hover:cursor-pointer hover:bg-light-gray dark:hover:bg-charleston-green hover:shadow hover:scale-[1.03] transition-all duration-150 ease-in-out"
                    onClick={() => navigateTo(item.sidebarKey)}
                  >
