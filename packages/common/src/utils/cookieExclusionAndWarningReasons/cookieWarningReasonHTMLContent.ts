...
export const WarnSameSiteUnspecifiedCrossSiteContextSetCookie = `
    <p class="font-medium">Indicate whether a cookie is intended to be set in cross-site context by specifying its SameSite attribute</p>
...
export const WarnSameSiteNoneInsecureReadCookie = `
    ...
    <p class="text-xxxs">In a future version of the browser, cookies marked with <code>SameSite=None</code> must also be marked with <code>Secure</code> to get sent in cross-site requests. This behavior protects user data from being sent over an insecure connection.</p>
    <p class="text-xxxs">Resolve this issue by updating the attributes of the cookie:</p>
    <ul>
        <li>Specify <code>SameSite=None</code> and <code>Secure</code> if the cookie should be sent in cross-site requests. This enables third-party use.</li>
        <li>Specify <code>SameSite=Strict</code> or <code>SameSite=Lax</code> if the cookie should not be sent in cross-site requests.</li>
...
export const WarnSameSiteNoneInsecureSetCookie = `
    ...
    <p class="text-xxxs">In a future version of the browser, cookies marked with <code>SameSite=None</code> must also be marked with <code>Secure</code> to allow setting them in a cross-site context. This behavior protects user data from being sent over an insecure connection.</p>
    <p class="text-xxxs">Resolve this issue by updating the attributes of the cookie:</p>
    <ul>
        <li>Specify <code>SameSite=None</code> and <code>Secure</code> if the cookie is intended to be set in cross-site contexts. Note that only cookies sent over HTTPS may use the <code>Secure</code> attribute.</li>
        <li>Specify <code>SameSite=Strict</code> or <code>SameSite=Lax</code> if the cookie should not be set by cross-site requests.</li>
...
export const WarnSameSiteStrictLaxDowngradeStrictSecure = `
    <p class="font-medium">Migrate entirely to HTTPS to continue having cookies sent on same-site requests</p>
...
export const WarnSameSiteStrictCrossDowngradeStrictReadCookieSecure = `
    <p class="font-medium">Migrate entirely to HTTPS to continue having cookies sent to same-site subresources</p>
...
export const WarnSameSiteStrictCrossDowngradeStrictSetCookieSecure = `
    <p class="font-medium">Migrate entirely to HTTPS to continue allowing cookies to be set by same-site subresources</p>
...
export const WarnAttributeValueExceedsMaxSize = `
    <p class="font-medium">Ensure cookie attribute values don't exceed 1024 characters</p>
    <p class="text-xxxs">Cookie attribute values exceeding 1024 characters in size will result in the attribute being ignored. This could lead to unexpected behavior since the cookie will be processed as if the offending attribute / attribute value pair were not present.</p>
    <p class="text-xxxs">Resolve this issue by ensuring that cookie attribute values don't exceed 1024 characters.</p>
`;
...
export const WarnDomainNonASCII = `
    ...
    <p class="text-xxxs"><code>Domain</code> attributes in cookies are restricted to the ASCII character set. Any cookies that contain characters outside of the ASCII range in their <code>Domain</code> attribute will be ignored in the future.</p>
...
export const WarnThirdPartyPhaseoutReadCookie = `
    <p class="font-medium">Cookie sent in cross-site context will be blocked in future Chrome versions</p>
    <p class="text-xxxs">In a future version of the browser, cookies marked with <code>SameSite=None; Secure</code> and not <code>Partitioned</code> will be blocked in cross-site requests. This behavior protects user data from cross-site tracking.</p>
`;

// Filename: cookieWarnThirdPartyPhaseoutSet.md
export const WarnThirdPartyPhaseoutSetCookie = `
    <p class="font-medium">Cookie set in cross-site context will be blocked in future Chrome versions</p>
    <p class="text-xxxs">In a future version of the browser, cookies marked with <code>SameSite=None; Secure</code> and not <code>Partitioned</code> will be blocked in cross-site context. This behavior protects user data from cross-site tracking.</p>
`;
